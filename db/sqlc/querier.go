...
type Querier interface {
	...
	GetSocialAccountByID(ctx context.Context, id pgtype.UUID) (Socialaccount, error)
	...
	ListSocialAccountsByUserID(ctx context.Context, arg ListSocialAccountsByUserIDParams) ([]Socialaccount, error)
